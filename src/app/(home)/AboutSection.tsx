  ...
  return (
    <section className="side-padding my-50 xl:my-70 mx-auto w-full max-w-[2000px] lg:my-60">
      <div className="relative flex flex-col gap-4">
        ...
        <h2
          ref={titleRef}
          className="overflow-hidden text-[12vw] font-semibold uppercase leading-[1] lg:text-[min(200px,10vw)] text-white mix-blend-difference"
        >
          <motion.span
        ...
        {/* img */}
        <div className="aspect-5/6  -z-1 w-[min(360px,80%)] self-end overflow-hidden md:absolute md:top-1/2 md:w-[min(700px,42%)] md:-translate-y-1/2">
          <Image
